...
public final class ItemModel {
	...
	public ItemModel(int i) {
		...
		cube16.polygons[1] = new Polygon(new Vertex[]{vertex5, vertex8, i2, vertex19}, f12, f13, f10, f20);
		cube16.polygons[2] = new Polygon(new Vertex[]{vertex18, vertex8, vertex5, vertex6}, f12, f13, f10, f20);
		cube16.polygons[3] = new Polygon(new Vertex[]{vertex7, vertex19, i2, vertex9}, f12, f13, f10, f20);
		cube16.polygons[4] = new Polygon(new Vertex[]{vertex6, vertex5, vertex19, vertex7}, f12, f13, f10, f20);
		cube16.polygons[5] = new Polygon(new Vertex[]{vertex8, vertex18, vertex9, i2}, f12, f13, f10, f20);
	}
