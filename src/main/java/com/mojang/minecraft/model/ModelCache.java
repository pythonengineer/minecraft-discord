...
public final class ModelCache {
    ...
    public final BaseModel getModel(String name) {
        return (BaseModel)(name.equals("humanoid") ? this.humanoidModel : (name.equals("humanoid.armor") ? this.humanoidArmorModel : (name.equals("creeper") ? this.creeperModel : (name.equals("skeleton") ? this.skeletonModel : (name.equals("zombie") ? this.zombieModel : (name.equals("pig") ? this.quadrupedModel : null))))));
    }
}
