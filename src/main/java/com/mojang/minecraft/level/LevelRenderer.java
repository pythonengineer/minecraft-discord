...
public final class LevelRenderer {
    ...
    private void compileSurroundingGround() {
        ...
        var1.begin(DefaultVertexFormats.POSITION_TEX);
    ...
    private void compileSurroundingWater() {
        ...
        var2.begin(DefaultVertexFormats.POSITION_TEX);
    ...
    public final void renderHit(Player var1, HitResult var2, int var3, int var4) {
        ...
        GL11.doPolygonOffset(-3.0F, -3.0F);
        ...
        if(var3 == 0) {
            var5.begin(DefaultVertexFormats.POSITION);
            ...
            GL11.glEnable(GL11.GL_TEXTURE_2D);
            int var7 = this.textureManager.loadTexture("/terrain.png", 9728);
            ...
            var5.begin(DefaultVertexFormats.POSITION_TEX);
            var5.noColor();
