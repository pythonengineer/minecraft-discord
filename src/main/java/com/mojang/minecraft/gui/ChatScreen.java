...
public final class ChatScreen extends Screen {
	...
	protected final void mousePressed(int i1, int i2, int i3) {
		if(i3 == 0 && this.minecraft.hud.hoveredUsername != null) {
			...
			i1 = 64 - (this.minecraft.user.name.length() + 2);
			if(this.typedMsg.length() > i1) {
				this.typedMsg = this.typedMsg.substring(0, i1);
			}
		}
