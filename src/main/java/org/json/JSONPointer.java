    ...
    public Object queryFrom(Object document) throws JSONPointerException {
        ...
        for (String token : this.refTokens) {
            if (current instanceof JSONObject) {
                ...
                throw new JSONPointerException("value is not an array or object therefore its key cannot be resolved");
            }
        }
        return current;
    }
    ...
    private static Object readByIndexToken(Object current, String indexToken) throws JSONPointerException {
        try {
            ...
            if (index >= currentArr.length()) {
                throw new JSONPointerException("index is out of bounds");
            }
            try {
            ...
            throw new JSONPointerException("not an array index", e);
        }
    }
