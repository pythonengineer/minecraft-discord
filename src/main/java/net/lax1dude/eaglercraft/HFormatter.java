 ...
 * to work like the {@code printf} function of the C programming language. Its
 * key methods are the {@code format} methods which create a formatted
 * {@code String} by replacing a set of placeholders (format tokens) with
 * formatted values. The style used to format each value is determined by the
 * format token used. For example, the call<br/>
 ...
 *
 * <p>
 * The format token consists of a percent sign, optionally followed by flags and
 * precision arguments, and then a single character that indicates the type of
 * value being formatted. If the type is a time/date, then the type character
 * {@code t} is followed by an additional character that indicates how the date
 * is to be formatted. The two characters {@code <$} immediately following the %
 * sign indicate that the previous value should be used again instead of moving
 * on to the next value argument. A number {@code n} and a dollar sign
 * immediately following the % sign make n the next argument to be used.
 *
 * <p>
 ...
 * <TD COLSPAN=4><B>Text value types</B></TD>
 * </tr>
 * <tr>
 ...
 * </tr>
 * <tr BGCOLOR="#CCCCFF" CLASS="TableHeadingColor">
 * <TD COLSPAN=4><B>Text option flags</B><br/>
 * The value between the option and the type character indicates the minimum
 * width in characters of the formatted value</TD>
 * </tr>
 * <tr>
 * <td width="5%">{@code -}</td>
 ...
 * </tr>
 * <tr BGCOLOR="#CCCCFF" CLASS="TableHeadingColor">
 * <TD COLSPAN=4><B>Integer types</B></TD>
 * </tr>
 * <tr>
 ...
 * </tr>
 * <tr BGCOLOR="#CCCCFF" CLASS="TableHeadingColor">
 * <TD COLSPAN=4><B>Integer option flags</B><br/>
 * The value between the option and the type character indicates the minimum
 * width in characters of the formatted value</TD>
 * </tr>
 * <tr>
 ...
 * <tr>
 * <td width="5%">{@code #}</td>
 * <td width="10%">Print the leading characters that indicate hexidecimal or
 * octal (for use only with hex and octal types)</td>
 * <td width="30%">{@code format("%#o", 010);}</td>
 * <td width="30%">{@code 010}</td>
 * </tr>
 * <tr>
 * <td width="5%">{@code  }</td>
 * <td width="10%">A space indicates that non-negative numbers should have a
 * leading space.</td>
 ...
 * <td width="10%">Pad the number with leading zeros (width value is
 * required)</td>
 ...
 * </tr>
 * <tr BGCOLOR="#CCCCFF" CLASS="TableHeadingColor">
 * <TD COLSPAN=4><B>Float types</B><br/>
 * A value immediately following the % symbol gives the minimum width in
 * characters of the formatted value; if it is followed by a period and another
 * integer, then the second value gives the precision (6 by default).</TD>
 * </tr>
 * <tr>
 * <td width="5%">{@code f}</td>
 * <td width="10%">float (or double) formatted as a decimal, where the precision
 * indicates the number of digits after the decimal.</td>
 * <td width=
 * "30%">{@code format("%f %<.1f %<1.5f %<10f %<6.0f", 123.456f);}</td>
 * <td width="30%">{@code 123.456001 123.5 123.45600 123.456001    123}</td>
 * </tr>
 * <tr>
 * <td width="5%">{@code E}, {@code e}</td>
 * <td width="10%">float (or double) formatted in decimal exponential notation,
 * where the precision indicates the number of significant digits.</td>
 * <td width=
 * "30%">{@code format("%E %<.1e %<1.5E %<10E %<6.0E", 123.456f);}</td>
 * <td width=
 * "30%">{@code 1.234560E+02 1.2e+02 1.23456E+02 1.234560E+02  1E+02}</td>
 * </tr>
 * <tr>
 * <td width="5%">{@code G}, {@code g}</td>
 * <td width="10%">float (or double) formatted in decimal exponential notation ,
 * where the precision indicates the maximum number of significant digits.</td>
 * <td width=
 * "30%">{@code format("%G %<.1g %<1.5G %<10G %<6.0G", 123.456f);}</td>
 ...
 * notation, where the precision indicates the number of significant
 * digits.</td>
 * <td width=
 * "30%">{@code format("%A %<.1a %<1.5A %<10A %<6.0A", 123.456f);}</td>
 * <td width=
 * "30%">{@code 0X1.EDD2F2P6 0x1.fp6 0X1.EDD2FP6 0X1.EDD2F2P6 0X1.FP6}</td>
 * </tr>
 * <tr BGCOLOR="#CCCCFF" CLASS="TableHeadingColor">
 * <TD COLSPAN=4><B>Float-type option flags</B><br/>
 * See the Integer-type options. The options for float-types are the same as for
 * integer types with one addition:</TD>
 * </tr>
 * <tr>
 * <td width="5%">{@code ,}</td>
 * <td width="10%">Use a comma in place of a decimal if the locale requires it.
 * </td>
 * <td width="30%">{@code format(new Locale("fr"), "%,7.2f", 6.03f);}</td>
 * <td width="30%">{@code    6,03}</td>
 * </tr>
 * <tr BGCOLOR="#CCCCFF" CLASS="TableHeadingColor">
 * <TD COLSPAN=4><B>Date types</B></TD>
 * </tr>
 * <tr>
 * <td width="5%">{@code t}, {@code T}</td>
 * <td width="10%">Date</td>
 * <td width=
 * "30%">{@code format(new Locale("fr"), "%tB %TB", Calendar.getInstance(), Calendar.getInstance());}</td>
 * <td width="30%">{@code avril AVRIL}</td>
 * </tr>
 * <tr BGCOLOR="#CCCCFF" CLASS="TableHeadingColor">
 * <TD COLSPAN=4><B>Date format precisions</B><br/>
 * The format precision character follows the {@code t}.</TD>
 * </tr>
 * <tr>
 * <td width="5%">{@code A}, {@code a}</td>
 ...
 * <tr>
 * <td width="5%">{@code D}</td>
 * <td width="10%">The complete date formatted as MM/DD/YY (not corrected for
 * locale)</td>
 * <td width="30%">{@code format(new Locale("en_US"), "%tD", cal);<br/>
 * format(new Locale("en_UK"), " %tD", cal);}</td>
 ...
 * <td width="10%">The hour of the day, in 12 or 24 hour format, with or without
 * a leading zero</td>
 ...
 * <td width="10%">The number of seconds or milliseconds from "the epoch" (1
 * January 1970 00:00:00 UTC)</td>
 ...
 * </tr>
 * <tr BGCOLOR="#CCCCFF" CLASS="TableHeadingColor">
 * <TD COLSPAN=4><B>Other data types</B></TD>
 * </tr>
 * <tr>
 ...
 * <td width="30%">{@code first<br/>
 * second}</td>
 * </tr>
 * <tr BGCOLOR="#CCCCFF" CLASS="TableHeadingColor">
 * <TD COLSPAN=4><B>Escape sequences</B></TD>
 * </tr>
 * <tr>
 * <td width="5%">{@code %}</td>
 ...
 *
 * <p>
 * An instance of Formatter can be created to write the formatted output to
 * standard types of output streams. Its functionality can also be accessed
 * through the format methods of an output stream or of {@code String}:<br/>
 * {@code System.out.println(HString.format("%ty\n", cal));}<br/>
 * {@code System.out.format("%ty\n", cal);}
 *
 * <p>
 * The class is not multi-threaded safe. The user is responsible for maintaining
 * a thread-safe design if a {@code Formatter} is accessed by multiple threads.
 *
 * @since 1.5
 */
public final class HFormatter implements Closeable, Flushable {
    ...
    public static class DuplicateFormatFlagsException extends IllegalArgumentException {
        ...
        public DuplicateFormatFlagsException(String s) {
            super(s);
        }
    ...
    public static class IllegalFormatWidthException extends IllegalArgumentException {
        ...
        public IllegalFormatWidthException(String s) {
            super(s);
        }
    ...
    /**
     * The enumeration giving the available styles for formatting very large decimal
     * numbers.
     */
     ...
     */
    public HFormatter(Appendable a) {
     ...
     *          {@code null}, then no localization will be used.
     */
    public HFormatter(Appendable a, Locale l) {
        if (null == a) {
     ...
     *                 will be created. The output of the {@code Formatter} is
     *                 buffered.
     * @throws FileNotFoundException if the filename does not denote a normal and
     *                               writable file, or if a new file cannot be
     *                               created, or if any error arises when opening or
     *                               creating the file.
     * @throws SecurityException     if there is a {@code SecurityManager} in place
     *                               which denies permission to write to the file in
     *                               {@code checkWrite(file.getPath())}.
     */
    public HFormatter(String fileName) throws FileNotFoundException {
     ...
     * @throws FileNotFoundException        if the filename does not denote a normal
     *                                      and writable file, or if a new file
     *                                      cannot be created, or if any error
     *                                      arises when opening or creating the
     *                                      file.
     * @throws SecurityException            if there is a {@code SecurityManager} in
     *                                      place which denies permission to write
     *                                      to the file in
     *                                      {@code checkWrite(file.getPath())}.
     * @throws UnsupportedEncodingException if the charset with the specified name
     *                                      is not supported.
     */
    public HFormatter(String fileName, String csn) throws FileNotFoundException, UnsupportedEncodingException {
     ...
     *                                      is not supported.
     */
    public HFormatter(String fileName, String csn, Locale l)
     ...
     *             be created. The output of the {@code Formatter} is buffered.
     * @throws FileNotFoundException if the {@code File} is not a normal and
     *                               writable {@code File}, or if a new {@code File}
     *                               cannot be created, or if any error rises when
     *                               opening or creating the {@code File}.
     * @throws SecurityException     if there is a {@code SecurityManager} in place
     *                               which denies permission to write to the
     *                               {@code File} in
     *                               {@code checkWrite(file.getPath())}.
     */
    public HFormatter(File file) throws FileNotFoundException {
     ...
     * @param csn  the name of the charset for the {@code Formatter}.
     * @throws FileNotFoundException        if the {@code File} is not a normal and
     *                                      writable {@code File}, or if a new
     *                                      {@code File} cannot be created, or if
     *                                      any error rises when opening or creating
     *                                      the {@code File}.
     * @throws SecurityException            if there is a {@code SecurityManager} in
     *                                      place which denies permission to write
     *                                      to the {@code File} in
     ...
     *                                      is not supported.
     */
    public HFormatter(File file, String csn) throws FileNotFoundException, UnsupportedEncodingException {
     ...
     *                                      is not supported.
     */
    public HFormatter(File file, String csn, Locale l) throws FileNotFoundException, UnsupportedEncodingException {
     ...
     *                                      is not supported.
     */
    public HFormatter(OutputStream os, String csn) throws UnsupportedEncodingException {
     ...
     *                                      is not supported.
     */
    public HFormatter(OutputStream os, String csn, Locale l) throws UnsupportedEncodingException {
     ...
     */
    public HFormatter(PrintStream ps) {
        if (null == ps) {
    ...
    private void checkClosed() {
        if (closed) {
            throw new IllegalStateException("Formatter is closed");
        }
    }
     ...
     *               string, then the additional arguments are ignored.
     * @return this {@code Formatter}.
     * @throws IllegalFormatException   if the format string is illegal or
     *                                  incompatible with the arguments, or if fewer
     *                                  arguments are sent than those required by
     *                                  the format string, or any other illegal
     *                                  situation.
     * @throws FormatterClosedException if the {@code Formatter} has been closed.
     */
    public HFormatter format(String format, Object... args) {
     ...
     * @throws FormatterClosedException if the {@code Formatter} has been closed.
     */
    public HFormatter format(Locale l, String format, Object... args) {
        checkClosed();
    ...
    private Object getArgument(Object[] args, int index, FormatToken token, Object lastArgument,
    ...
    /*
     * Information about the format string of a specified argument, which includes
     * the conversion type, flags, width, precision and the argument index as well
     * as the plainText that contains the whole format string used as the result for
     * output if necessary. Besides, the string for flags is recorded to construct
     * corresponding FormatExceptions if necessary.
     */
    private static class FormatToken {
        ...
        /*
         * Sets qualified char as one of the flags. If the char is qualified, sets it as
         * a flag and returns true. Or else returns false.
         */
    ...
    private static class Transformer {
        ...
        /*
         * Transforms percent to a formatted string. Only '-' is legal flag. Precision
         * is illegal.
         */
        ...
        private String transformFromInteger() {
            ...
            if ('d' == currentConversionType) {
                ...
                result.append(arg); // TODO: why is TeaVM's NumberFormat broken? (it always puts commas)
            } else {
         ...
         * formatToken.FLAG_PARENTHESIS is set. 'result' is used as an in-out parameter.
         */
        ...
        private String transformFromBigInteger() {
            ...
            if ('d' == currentConversionType) {
                ...
                result.append(bigInt); // TODO: why is TeaVM's NumberFormat broken? (it always puts commas)
            } else if ('o' == currentConversionType) {
        ...
        private String transformFromFloat() {
            ...
            if ('a' != Character.toLowerCase(currentConversionType)) {
                formatToken.setPrecision(
                        formatToken.isPrecisionSet() ? formatToken.getPrecision() : FormatToken.DEFAULT_PRECISION);
            }
            // output result
            FloatUtil floatUtil = new FloatUtil(result, formatToken, (DecimalFormat)NumberFormat.getInstance(locale),
                    arg);
    ...
    private static class DateTimeUtil {
        ...
        void transform(FormatToken formatToken, Calendar aCalendar, StringBuilder aResult) {
            this.result = aResult;
            ...
            switch (suffix) {
                ...
                default: {
                    throw new UnknownFormatConversionException(
                            String.valueOf(formatToken.getConversionType()) + formatToken.getDateSuffix());
                }
            }
        }
    ...
    private static class ParserStateMachine {
        ...
        /*
         * Gets the information about the current format token. Information is recorded
         * in the FormatToken returned and the position of the stream for the format
         * string will be advanced till the next format token.
         */
        ...
        private String getFormatString() {
            ...
            format.rewind();
            String formatString = format.subSequence(token.getFormatStringStartIndex(), end).toString();
            format.position(end);
            return formatString;
        }
