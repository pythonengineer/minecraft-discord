...
public abstract class CraftingInventoryCB {
    ...
    public ItemStack func_20116_a(int var1, int var2, int mode, EntityPlayer var3) {
        ...
        if (mode == 5) {
            ...
            if ((i != 1 || this.dragEvent != 2) && i != this.dragEvent) {
                this.resetDrag();
            } else if (var3.inventory.func_20075_i() == null) {
                this.resetDrag();
                ...
                if (slot != null && canAddItemToSlot(slot, var3.inventory.func_20075_i(), true)
                        && slot.isItemValid(var3.inventory.func_20075_i())
                        && var3.inventory.func_20075_i().stackSize > this.dragSlots.size()
                        && this.canDragIntoSlot(slot)) {
                    this.dragSlots.add(slot);
                }
            } else if (this.dragEvent == 2) {
                if (!this.dragSlots.isEmpty()) {
                    ItemStack itemstack3 = var3.inventory.func_20075_i().copy();
                    int j = var3.inventory.func_20075_i().stackSize;

                    for (Slot slot1 : this.dragSlots) {
                        if (slot1 != null && canAddItemToSlot(slot1, var3.inventory.func_20075_i(), true)
                                && slot1.isItemValid(var3.inventory.func_20075_i())
                                && var3.inventory.func_20075_i().stackSize >= this.dragSlots.size()
                    ...
                    var3.inventory.func_20076_b(itemstack3);
                }
            ...
            if (slotId == -999) {
                if (var3.inventory.func_20075_i() != null) {
                    if (clickedButton == 0) {
                        var3.dropPlayerItem(var3.inventory.func_20075_i());
                        var3.inventory.func_20076_b(null);
                    }

                    if (clickedButton == 1) {
                        var3.dropPlayerItem(var3.inventory.func_20075_i().splitStack(1));
                        if (var3.inventory.func_20075_i().stackSize == 0) {
                            var3.inventory.func_20076_b(null);
                        }
                    }
                }
                ...
                if (slot7 != null) {
                    ...
                    ItemStack itemstack10 = var3.inventory.func_20075_i();
                    if (itemstack9 != null) {
                    ...
                    if (itemstack9 == null) {
                        ...
                        if (itemstack10 == null) {
                            ...
                            var3.inventory.func_20076_b(itemstack12);
                            ...
                            if (itemstack9.getItem() == itemstack10.getItem()) {
                                ...
                                var3.inventory.func_20076_b(itemstack9);
                            }
        ...
        } else if (mode == 3 && false && var3.inventory.func_20075_i() == null
            ...
            if (slot4 != null && slot4.getHasStack()) {
                ...
                var3.inventory.func_20076_b(itemstack6);
            }
        } else if (mode == 4 && var3.inventory.func_20075_i() == null && slotId >= 0) {
            ...
            ItemStack itemstack4 = var3.inventory.func_20075_i();
	...
	private List<int[]> planShiftClick(int slotId, int button, EntityPlayer player) {
		...
		ItemStack heldBefore = player.inventory.func_20075_i();
	...
	private List<int[]> planDoubleClick(int slotId, EntityPlayer player) {
		List<int[]> clicks = new ArrayList<int[]>();
		ItemStack held = player.inventory.func_20075_i();
		if (held == null) {
			return clicks;
		}
	...
	private void restoreSlots(ItemStack[] snap, ItemStack held, EntityPlayer player) {
		...
		player.inventory.func_20076_b(held == null ? null : held.copy());
	}

	private static boolean sameItem(ItemStack a, ItemStack b) {
		return a != null && b != null && a.itemID == b.itemID && a.itemDamage == b.itemDamage;
	}
