...
public class WorldChunkManager {
	...
	public WorldChunkManager(World var1) {
		this.field_4194_e = new NoiseGeneratorOctaves2(new EaglercraftRandom(var1.getRandomSeed() * 9871L), 4);
		this.field_4193_f = new NoiseGeneratorOctaves2(new EaglercraftRandom(var1.getRandomSeed() * 39811L), 4);
