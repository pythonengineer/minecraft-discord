...
public class SaveFormatOld implements ISaveFormat {
	...
	public void func_22170_a(String var1, String var2) {
		...
		if(var4.exists()) {
            ...
            try (InputStream fis = var4.getInputStream()) {
				var5 = CompressedStreamTools.func_1138_a(fis);
            ...
            try (OutputStream fos = var4.getOutputStream()) {
                CompressedStreamTools.writeGzippedCompoundToOutputStream(var5, fos);
            } catch (Exception var7) {
                var7.printStackTrace();
                return;
            }
	...
	public void func_22172_c(String var1) {
		VFile2 var2 = new VFile2(this.field_22180_a, var1);
		func_22179_a(var2.listFiles(true));
		var2.delete();
	}

	protected static void func_22179_a(List<VFile2> var0) {
