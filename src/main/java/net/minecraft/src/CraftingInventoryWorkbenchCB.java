...
public class CraftingInventoryWorkbenchCB extends CraftingInventoryCB {
	...
	public CraftingInventoryWorkbenchCB(InventoryPlayer var1, World var2, int var3, int var4, int var5) {
		...
		this.func_20117_a(new SlotCrafting(this.craftMatrix, this.craftResult, 0, 124, 35));

		int var6;
		int var7;
		for(var6 = 0; var6 < 3; ++var6) {
			for(var7 = 0; var7 < 3; ++var7) {
				this.func_20117_a(new Slot(this.craftMatrix, var7 + var6 * 3, 30 + var7 * 18, 17 + var6 * 18));
			}
		}
