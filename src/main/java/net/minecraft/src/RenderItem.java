...
public class RenderItem extends Render {
    ...
    public void renderItemOverlayIntoGUI(FontRenderer fontRenderer, RenderEngine var2, ItemStack stack, int x, int y) {
        this.renderItemOverlayIntoGUI(fontRenderer, var2, stack, x, y, null);
    }

	public void renderItemOverlayIntoGUI(FontRenderer var1, RenderEngine var2, ItemStack stack, int var4, int var5, String s) {
		if(stack != null) {
