...
public class RenderPlayer extends RenderLiving {
	private ModelBiped modelBipedMain = (ModelBiped)this.field_20920_e;
	...
	protected boolean setArmorModel(EntityPlayer var1, int var2, float var3) {
		...
		if(var4 != null) {
			...
			if(var5 instanceof ItemArmor) {
				...
				var7.bipedHead.field_1403_h = var2 == 0;
				var7.bipedHeadwear.field_1403_h = var2 == 0;
				var7.bipedBody.field_1403_h = var2 == 1 || var2 == 2;
				var7.bipedRightArm.field_1403_h = var2 == 1;
				var7.bipedLeftArm.field_1403_h = var2 == 1;
				var7.bipedRightLeg.field_1403_h = var2 == 2 || var2 == 3;
				var7.bipedLeftLeg.field_1403_h = var2 == 2 || var2 == 3;
	...
	public void func_188_a(EntityPlayer var1, double var2, double var4, double var6, float var8, float var9) {
		...
		this.field_208_g.field_1278_i = this.field_207_h.field_1278_i = this.modelBipedMain.field_1278_i = var10 != null;
		this.field_208_g.field_1277_j = this.field_207_h.field_1277_j = this.modelBipedMain.field_1277_j = var1.isSneaking();
		...
		this.field_208_g.field_1277_j = this.field_207_h.field_1277_j = this.modelBipedMain.field_1277_j = false;
		this.field_208_g.field_1278_i = this.field_207_h.field_1278_i = this.modelBipedMain.field_1278_i = false;
		float var13 = 1.6F;
		...
		if(var15 < var16) {
			...
			if(!var1.isSneaking()) {
				...
				byte var20 = 0;
				if(var1.username.equals("deadmau5")) {
					var20 = -10;
				}
	...
	protected void func_4015_a(EntityPlayer var1, float var2) {
		...
		if(var1.username.equals("deadmau5") && this.loadDownloadableImageTexture(var1.skinUrl, (String)null)) {
			for(int var19 = 0; var19 < 2; ++var19) {
				...
				this.modelBipedMain.func_20095_a(1.0F / 16.0F);
				GL11.glPopMatrix();
			}
		}
		...
		if(this.loadDownloadableImageTexture(var1.field_20067_q, (String)null)) {
			...
			GL11.glRotatef(180.0F, 0.0F, 1.0F, 0.0F);
			this.modelBipedMain.func_20096_b(1.0F / 16.0F);
			GL11.glPopMatrix();
		}
