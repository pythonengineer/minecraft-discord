...
public class MapStorage {
	...
	public MapDataBase loadData(Class var1, String var2) {
		...
		if(var3 != null) {
			...
			if(this.field_28191_a != null) {
				VFile2 var4 = this.field_28191_a.func_28113_a(var2);
				if(var4 != null && var4.exists()) {
	                ...
	                try (InputStream fis = var4.getInputStream()) {
    					NBTTagCompound var6 = CompressedStreamTools.func_1138_a(fis);
	...
	private void saveData(MapDataBase var1) {
		if(this.field_28191_a != null) {
			VFile2 var2 = this.field_28191_a.func_28113_a(var1.field_28168_a);
			if(var2 != null) {
	...
	private void loadIdCounts() {
		...
		VFile2 var1 = this.field_28191_a.func_28113_a("idcounts");
		if(var1 != null && var1.exists()) {
            try (InputStream fis = var1.getInputStream()) {
    			DataInputStream var2 = new DataInputStream(fis);
	...
	public int getUniqueDataId(String var1) {
		...
		if(this.field_28191_a == null) {
			...
			VFile2 var3 = this.field_28191_a.func_28113_a("idcounts");
			if(var3 != null) {
				NBTTagCompound var4 = new NBTTagCompound();
                ...
                try (OutputStream fos = var3.getOutputStream()) {
    				DataOutputStream var9 = new DataOutputStream(fos);
