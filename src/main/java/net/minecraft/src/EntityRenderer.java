...
public class EntityRenderer {
	...
	public void updateCameraAndRender(float var1) {
		...
		if(!this.mc.skipRenderWorld) {
			...
			ScaledResolution var13 = new ScaledResolution(this.mc);
			int var14 = var13.getScaledWidth();
			int var15 = var13.getScaledHeight();
			int var16 = PointerInputAbstraction.getX() * var14 / this.mc.displayWidth;
			int var17 = var15 - PointerInputAbstraction.getY() * var15 / this.mc.displayHeight - 1;
			short var7 = 200;
