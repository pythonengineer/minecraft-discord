...
public final class RenderHelper {
	...
	public static void enableStandardItemLighting() {
        ...
        Vec3D var0 = new Vec3D((double)0.3F, 1.0D, (double)-0.7F);
        GL11.glLight(GL11.GL_LIGHT0, GL11.GL_POSITION, setColorBuffer(var0.xCoord, var0.yCoord, var0.zCoord, 0.0D));
        ...
        var0 = new Vec3D((double)-0.7F, 1.0D, (double)0.2F);
        GL11.glLight(GL11.GL_LIGHT1, GL11.GL_POSITION, setColorBuffer(var0.xCoord, var0.yCoord, var0.zCoord, 0.0D));
    ...
    private static FloatBuffer setColorBuffer(double var0, double var2, double var4, double var6) {
        return setColorBuffer((float)var0, (float)var2, (float)var4, 0.0F);
    }
