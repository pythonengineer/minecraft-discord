...
public final class RenderHelper {
	...
	public static void enableStandardItemLighting() {
		...
		Vec3D var3 = new Vec3D(0.0F, 1.0F, 1.0F);
		GL11.glLight(GL11.GL_LIGHT0, GL11.GL_POSITION, setColorBuffer(var3.xCoord, var3.yCoord, var3.zCoord, 0.0F));
		...
		var3 = new Vec3D(0.0F, 1.0F, -1.0F);
		GL11.glLight(GL11.GL_LIGHT1, GL11.GL_POSITION, setColorBuffer(var3.xCoord, var3.yCoord, var3.zCoord, 0.0F));
