...
public class RenderHelper {
	...
	public static void enableStandardItemLighting() {
        ...
        Vec3D vec3D0 = Vec3D.createVector((double)0.2F, 1.0D, -0.699999988079071D).normalize();
        ...
        vec3D0 = Vec3D.createVector(-0.20000000298023224D, 1.0D, (double)0.7F).normalize();
