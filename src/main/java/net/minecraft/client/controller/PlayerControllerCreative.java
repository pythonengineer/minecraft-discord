    ...
    public final void flipPlayer(EntityPlayer var1) {
        for(int var2 = 0; var2 < 9; ++var2) {
            if(var1.inventory.mainInventory[var2] == null) {
                this.a.thePlayer.inventory.mainInventory[var2] = new ItemStack(Block.blocksList[((Block)Session.allowedBlocks.get(var2)).blockID]);
            } else {
                this.a.thePlayer.inventory.mainInventory[var2].stackSize = 1;
            }
        }
