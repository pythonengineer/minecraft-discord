...
public final class GuiMainMenu extends GuiScreen {
    ...
    public final void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        float f15;
        GL11.glScalef(f15 = (1.8F - MathHelper.abs(MathHelper.sin((float)(EagRuntime.currentTimeMillis() % 1000L) / 1000.0F * (float)Math.PI * 2.0F) * 0.1F)) * 100.0F / (float)(this.fontRenderer.width(this.splashString) + 32), f15, f15);
        ...
        drawString(this.fontRenderer, string16, this.width - this.fontRenderer.width(string16) - 2, this.height - 10, 0xFFFFFF);
