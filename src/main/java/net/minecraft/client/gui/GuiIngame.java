...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float partialTicks) {
        ...
        if(this.mc.options.showFPS) {
            this.mc.fontRenderer.drawStringWithShadow("Minecraft Alpha v1.0.4 (" + this.mc.debug + ")", 2, 2, 0xFFFFFF);
            ...
            this.mc.fontRenderer.drawStringWithShadow("Minecraft Alpha v1.0.4", 2, 2, 0xFFFFFF);
        }
