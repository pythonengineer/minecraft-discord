...
public class GuiChest extends GuiContainer {
    ...
    public GuiChest(IInventory upperChestInventory, IInventory lowerChestInventory) {
        ...
        for(i4 = 0; i4 < this.inventoryRows; ++i4) {
            for(i5 = 0; i5 < 9; ++i5) {
                this.inventorySlots.add(new SlotInventory(this, lowerChestInventory, i5 + i4 * 9, 8 + i5 * 18, 18 + i4 * 18));
            }
        }

        for(i4 = 0; i4 < 3; ++i4) {
            for(i5 = 0; i5 < 9; ++i5) {
                this.inventorySlots.add(new SlotInventory(this, upperChestInventory, i5 + (i4 + 1) * 9, 8 + i5 * 18, 103 + i4 * 18 + i3));
            }
        }

        for(i4 = 0; i4 < 9; ++i4) {
            this.inventorySlots.add(new SlotInventory(this, upperChestInventory, i4, 8 + i4 * 18, i3 + 161));
        }
