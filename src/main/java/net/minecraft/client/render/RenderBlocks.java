...
public final class RenderBlocks {
	...
	public final boolean renderBlockByRenderType(Block block, int x, int y, int z) {
		...
		if((i5 = block.getRenderType()) == 0) {
			...
			z46 = false;
			float f48 = block.getBrightness(this.worldObj, x, y, z);
			if(this.renderAllFaces || block.getIsBlockSolid(this.worldObj, x, y - 1, z, 0)) {
				f18 = block.getBrightness(this.worldObj, x, y - 1, z);
			...
			if(this.renderAllFaces || block.getIsBlockSolid(this.worldObj, x, y, z - 1, 2)) {
				f18 = block.getBrightness(this.worldObj, x, y, z - 1);
				if(Block.lightValue[block.blockID] > 0) {
					f18 = 1.0F;
				}
			...
			if(this.renderAllFaces || block.getIsBlockSolid(this.worldObj, x - 1, y, z, 4)) {
				f18 = block.getBrightness(this.worldObj, x - 1, y, z);
				if(Block.lightValue[block.blockID] > 0) {
					f18 = 1.0F;
				}
			...
			if(i5 == 4) {
				...
				d17 = block.minY;
				d51 = block.maxY;
				block.maxY = d51 - (double)this.getFluidHeight(x, y, z);
				float f50;
				if(this.renderAllFaces || block.getIsBlockSolid(this.worldObj, x, y - 1, z, 0)) {
					f50 = block.getBrightness(this.worldObj, x, y - 1, z);
					tessellator6.setColorOpaque_F(0.5F * f50, 0.5F * f50, 0.5F * f50);
				...
				if(this.renderAllFaces || block.getIsBlockSolid(this.worldObj, x, y + 1, z, 1)) {
					f50 = block.getBrightness(this.worldObj, x, y + 1, z);
					tessellator6.setColorOpaque_F(f50 * 1.0F, f50 * 1.0F, f50 * 1.0F);
					this.renderTopFace(block, (double)x, (double)y, (double)z, block.getBlockTextureFromSide(1));
					z46 = true;
				}

				block.minY = d51 - (double)this.getFluidHeight(x, y, z - 1);
				if(this.renderAllFaces || block.maxY > block.minY || block.getIsBlockSolid(this.worldObj, x, y, z - 1, 2)) {
					f50 = block.getBrightness(this.worldObj, x, y, z - 1);
					tessellator6.setColorOpaque_F(0.8F * f50, 0.8F * f50, 0.8F * f50);
				...
				block.minY = d51 - (double)this.getFluidHeight(x - 1, y, z);
				if(this.renderAllFaces || block.maxY > block.minY || block.getIsBlockSolid(this.worldObj, x - 1, y, z, 4)) {
					f50 = block.getBrightness(this.worldObj, x - 1, y, z);
					tessellator6.setColorOpaque_F(0.6F * f50, 0.6F * f50, 0.6F * f50);
				...
				if(i5 == 1) {
					tessellator6 = Tessellator.instance;
					f45 = block.getBrightness(this.worldObj, x, y, z);
					...
					if(i5 == 2) {
						...
						f8 = block.getBrightness(this.worldObj, x, y, z);
						if(Block.lightValue[block.blockID] > 0) {
							f8 = 1.0F;
						}
						...
						if(i5 == 3) {
							...
							f8 = block.getBrightness(this.worldObj, x, z, i5);
							...
							d17 = (double)((float)x / 256.0F);
							d51 = (double)(((float)x + 15.99F) / 256.0F);
							...
							if(this.worldObj.isBlockNormalCube(y - 1, z, i5)) {
								...
								tessellator6.addVertexWithUV((double)((float)y + 0.05F), (double)((float)z - 0.125F), (double)((float)i5 - 0.125F), d51, d23);
								tessellator6.addVertexWithUV((double)((float)y + 0.05F), (double)((float)(z + 1) + 0.125F), (double)((float)i5 - 0.125F), d51, d21);
							}

							if(this.worldObj.isBlockNormalCube(y + 1, z, i5)) {
								tessellator6.addVertexWithUV((double)((float)(y + 1) - 0.05F), (double)((float)z - 0.125F), (double)((float)(i5 + 1) + 0.125F), d51, d23);
								tessellator6.addVertexWithUV((double)((float)(y + 1) - 0.05F), (double)((float)(z + 1) + 0.125F), (double)((float)(i5 + 1) + 0.125F), d51, d21);
							...
							tessellator6 = Tessellator.instance;
							BlockDoor blockDoor7;
							(blockDoor7 = (BlockDoor)block).setBlockBoundsBasedOnState(this.worldObj, x, y, z);
							f18 = block.getBrightness(this.worldObj, x, y, z);
							float f19 = block.getBrightness(this.worldObj, x, y - 1, z);
							...
							this.renderBottomFace(block, (double)x, (double)y, (double)z, block.getBlockTexture(this.worldObj, x, y, z, 0));
							f19 = block.getBrightness(this.worldObj, x, y + 1, z);
							...
							this.renderTopFace(block, (double)x, (double)y, (double)z, block.getBlockTexture(this.worldObj, x, y, z, 1));
							f19 = block.getBrightness(this.worldObj, x, y, z - 1);
							...
							tessellator6.setColorOpaque_F(0.8F * f19, 0.8F * f19, 0.8F * f19);
							this.renderWestFace(block, (double)x, (double)y, (double)z, block.getBlockTexture(this.worldObj, x, y, z, 3));
							f19 = block.getBrightness(this.worldObj, x - 1, y, z);
	...
	private float getFluidHeight(int x, int y, int z) {
		return this.worldObj.getBlockMaterial(x, y, z) != Material.water ? 1.0F : (float)this.worldObj.getBlockMetadata(x, y, z) / 9.0F;
	}
