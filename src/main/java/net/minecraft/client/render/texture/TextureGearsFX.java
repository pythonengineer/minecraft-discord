...
public class TextureGearsFX extends TextureFX {
	...
	public TextureGearsFX(int i1) {
        ...
        try {
            bufferedImage = ImageData.loadImageFile("/assets/misc/gear.png");
            bufferedImage.getRGB(0, 0, 32, 32, this.gearColor, 0, 32);
            bufferedImage = ImageData.loadImageFile("/assets/misc/gearmiddle.png");
            bufferedImage.getRGB(0, 0, 16, 16, this.gearMiddleColor, 0, 16);
        } catch (Exception exc) {
