...
public class RenderLiving extends Render {
	...
	public void renderLiving(EntityLiving var1, float var2, float var3, float var4, float var5, float var6) {
		GL11.glPushMatrix();
		...
		try {
			...
			float var15 = var1.getBrightness(var6);
	...
	public void doRender(Entity var1, float var2, float var3, float var4, float var5, float var6) {
		this.renderLiving((EntityLiving)var1, var2, var3, var4, var5, var6);
	}
}
