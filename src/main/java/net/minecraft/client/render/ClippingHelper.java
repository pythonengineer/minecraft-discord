...
public class ClippingHelper {
    ...
    public final boolean isBoundingBoxInFrustrum1(float var1, float var2, float var3, float var4, float var5, float var6) {
    ...
    public final boolean isBoundingBoxInFrustrum(AxisAlignedBB var1) {
        return this.isBoundingBoxInFrustrum(var1.minX, var1.minY, var1.minZ, var1.maxX, var1.maxY, var1.maxZ);
    }
}
