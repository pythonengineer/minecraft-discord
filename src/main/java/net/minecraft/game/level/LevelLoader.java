...
public abstract class LevelLoader {
    ...
    public final World load(InputStream var1) throws IOException {
        if(this.loadingScreen != null) {
            this.loadingScreen.displayProgressMessage("Loading level");
        }

        if(this.loadingScreen != null) {
            this.loadingScreen.displayLoadingString("Reading..");
        }
        ...
        if(this.loadingScreen != null) {
            this.loadingScreen.displayLoadingString("Preparing level..");
        }
        ...
        if(this.loadingScreen != null) {
            this.loadingScreen.displayLoadingString("Preparing entities..");
        }
    ...
    public final void save(World var1, OutputStream var2) throws IOException {
        if(this.loadingScreen != null) {
            this.loadingScreen.displayProgressMessage("Saving level");
        }
        ...
        if(this.loadingScreen != null) {
            this.loadingScreen.displayLoadingString("Writing..");
        }
