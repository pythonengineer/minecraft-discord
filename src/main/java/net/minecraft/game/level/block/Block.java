...
public class Block {
    ...
    static {
        Block var10000 = (new BlockStone(1, 1)).setHardness(1.0F).setResistance(10.0F);
        ...
        var0.stepSound = var1;
        dirt = var0;
        var10000 = (new Block(4, 16)).setHardness(1.5F).setResistance(10.0F);
        var1 = soundStoneFootstep;
        var0 = var10000;
        var0.stepSound = var1;
        cobblestone = var0;
        var10000 = (new Block(5, 4)).setHardness(1.5F).setResistance(5.0F);
        ...
        var0.stepSound = var1;
        sapling = var0;
        var10000 = (new Block(7, 17)).setHardness(999.0F).setResistance(6000000.0F);
        var1 = soundStoneFootstep;
        var0 = var10000;
        var0.stepSound = var1;
        bedrock = var0;
        ...
        var0.stepSound = var1;
        mushroomRed = var0;
        var10000 = (new BlockOreBlock(41, 40)).setHardness(3.0F).setResistance(10.0F);
        var1 = soundMetalFootstep;
        var0 = var10000;
        var0.stepSound = var1;
        blockGold = var0;
        var10000 = (new BlockOreBlock(42, 39)).setHardness(5.0F).setResistance(10.0F);
        var1 = soundMetalFootstep;
        var0 = var10000;
        var0.stepSound = var1;
        blockSteel = var0;
        ...
        var0.stepSound = var1;
        stairSingle = var0;
        var10000 = (new Block(45, 7)).setHardness(2.0F).setResistance(10.0F);
        var1 = soundStoneFootstep;
        var0 = var10000;
        var0.stepSound = var1;
        brick = var0;
        ...
        var0.stepSound = var1;
        bookShelf = var0;
        var10000 = (new Block(48, 36)).setHardness(1.0F).setResistance(10.0F);
        var1 = soundStoneFootstep;
        var0 = var10000;
        var0.stepSound = var1;
