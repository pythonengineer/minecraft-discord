...
public class BlockFluid extends Block {
	...
	public final int getBlockTexture(int var1) {
		return this.liquidMaterial == Material.lava ? this.blockIndexInTexture : (var1 == 1 ? this.blockIndexInTexture : (var1 == 0 ? this.blockIndexInTexture : this.blockIndexInTexture + 32));
	}
	...
	public boolean update(World var1, int var2, int var3, int var4, int var5) {
		...
		} while(var6 && this.liquidMaterial != Material.lava);

		++var3;
		if(this.liquidMaterial == Material.water || !var7) {
		...
		if(this.liquidMaterial == Material.lava) {
	...
	protected final boolean canFlow(World var1, int var2, int var3, int var4) {
		...
		if(var5 != 0 && var5 != Block.fire.blockID) {
			...
			if(this.liquidMaterial == Material.water) {
	...
	public final float getBlockBrightness(World var1, int var2, int var3, int var4) {
		return this.liquidMaterial == Material.lava ? 100.0F : var1.getBlockLightValue(var2, var3, var4);
	}
	...
	public void onNeighborBlockChange(World var1, int var2, int var3, int var4, int var5) {
		if(var5 != 0) {
			...
			if(this.liquidMaterial == Material.water && var6 == Material.lava || var6 == Material.water && this.liquidMaterial == Material.lava) {
	...
	public int tickRate() {
		return this.liquidMaterial == Material.lava ? 25 : 5;
	}
	...
	public int getRenderBlockPass() {
		return this.liquidMaterial == Material.water ? 1 : 0;
	}

	public final void randomDisplayTick(World var1, int var2, int var3, int var4, EaglercraftRandom var5) {
		if(this.liquidMaterial == Material.lava && var1.getBlockMaterial(var2, var3 + 1, var4) == Material.air && !var1.isBlockNormalCube(var2, var3 + 1, var4) && var5.nextInt(100) == 0) {
