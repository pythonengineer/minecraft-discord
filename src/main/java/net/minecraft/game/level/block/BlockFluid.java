...
public class BlockFluid extends Block {
    ...
    protected int stillId0;
    protected int movingId0;
    ...
    public boolean update(World var1, int var2, int var3, int var4, int var5) {
        ...
        do {
            ...
            var6 = var1.setBlockWithNotify(var2, var3, var4, this.movingId0);
            if(var6) {
                var7 = true;
            }
        ...
        if(!var7) {
            var1.setTileNoUpdate(var2, var3, var4, this.stillId0);
        } else {
    ...
    private boolean flow(World var1, int var2, int var3, int var4) {
        if(!this.canFlow(var1, var2, var3, var4)) {
            ...
            boolean var5 = var1.setBlockWithNotify(var2, var3, var4, this.movingId0);
            if(var5) {
                var1.scheduleBlockUpdate(var2, var3, var4, this.movingId0);
            }
    ...
    public boolean shouldSideBeRendered(World var1, int var2, int var3, int var4, int var5) {
        if(var2 >= 0 && var3 >= 0 && var4 >= 0 && var2 < var1.width && var4 < var1.length) {
            ...
            return var6 != this.movingId0 && var6 != this.stillId0 ? (var5 != 1 || var1.getBlockId(var2 - 1, var3, var4) != 0 && var1.getBlockId(var2 + 1, var3, var4) != 0 && var1.getBlockId(var2, var3, var4 - 1) != 0 && var1.getBlockId(var2, var3, var4 + 1) != 0 ? super.shouldSideBeRendered(var1, var2, var3, var4, var5) : true) : false;
        } else {
            return false;
        }
    }
