...
public final class BlockFlowing extends BlockFluid {
	...
	public final boolean update(World var1, int var2, int var3, int var4, int var5) {
		...
		if(var6 && var1.getBlockMaterial(var2, var3 - 1, var4) == this.liquidMaterial1 && !var1.floodFill(var2, var3 - 1, var4, this.movingId1, this.stillId1)) {
			return false;
		} else {
			...
			if(!var10 && var6) {
				if(this.rand.nextInt(3) == 0) {
					...
					} else if(this.liquidMaterial1 == Material.lava) {
				...
				if(this.liquidMaterial1 == Material.water) {
				...
				if(this.liquidMaterial1 == Material.lava) {
	...
	public final int tickRate() {
		return this.liquidMaterial1 == Material.lava ? 25 : 5;
	}
	...
	public final int getRenderBlockPass() {
		return this.liquidMaterial1 == Material.water ? 1 : 0;
	}
