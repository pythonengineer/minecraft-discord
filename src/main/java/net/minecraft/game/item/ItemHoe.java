    ...
    public final boolean onItemUse(ItemStack var1, World var2, int var3, int var4, int var5, int var6) {
        if(var3 > 0 && var4 > 0 && var5 > 0 && var3 < var2.width - 1 && var4 < var2.height - 1 && var5 < var2.length - 1) {
            ...
            if(var6 != Block.grass.blockID && var6 != Block.dirt.blockID) {
                ...
                Block var7 = Block.tilledField;
                float var10001 = (float)var3 + 0.5F;
                float var10002 = (float)var4 + 0.5F;
                float var10003 = (float)var5 + 0.5F;
                String var10004 = "step." + var7.stepSound.sound;
                StepSound var8 = var7.stepSound;
                ...
                var2.setBlockWithNotify(var3, var4, var5, var7.blockID);
                var1.damageItem(1);
                if(var2.random.nextInt(8) == 0 && var6 == Block.grass.blockID) {
                    for(int var9 = 0; var9 <= 0; ++var9) {
                        ...
                        float var12 = var2.random.nextFloat() * 0.7F + 0.15F;
                        EntityItem var11 = new EntityItem(var2, (float)var3 + var10, (float)var4 + 1.2F, (float)var5 + var12, new ItemStack(Item.seeds));
