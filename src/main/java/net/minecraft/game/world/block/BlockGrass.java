...
public final class BlockGrass extends Block {
    ...
    public final void updateTick(World var1, int var2, int var3, int var4, EaglercraftRandom var5) {
        if(var1.canExistingBlockSeeTheSky(var2, var3 + 1, var4) < 4 && var1.getBlockMaterial(var2, var3 + 1, var4).getCanBlockGrass()) {
            if(var5.nextInt(4) == 0) {
            ...
            if(var1.canExistingBlockSeeTheSky(var2, var3 + 1, var4) >= 9) {
                ...
                if(var1.getBlockId(var2, var3, var4) == Block.dirt.blockID && var1.canExistingBlockSeeTheSky(var2, var3 + 1, var4) >= 4 && !var1.getBlockMaterial(var2, var3 + 1, var4).getCanBlockGrass()) {
