...
public abstract class BlockFluid extends Block {
    ...
    private Vec3D getFlowVector(World world, int x, int y, int z) {
        ...
        for(int i7 = 0; i7 < 4; ++i7) {
            ...
            int i10;
            if((i10 = this.getEffectiveFlowDecay(world, i8, y, i9)) < 0) {
                if((i10 = this.getEffectiveFlowDecay(world, i8, y - 1, i9)) >= 0) {
                    i10 -= i6 - 8;
        ...
        if(world.getBlockMetadata(x, y, z) >= 8) {
            boolean z11 = false;
            if(this.getIsBlockSolid(world, x, y, z - 1, 2)) {
                z11 = true;
            }

            if(z11 || this.getIsBlockSolid(world, x, y, z + 1, 3)) {
                z11 = true;
            }

            if(z11 || this.getIsBlockSolid(world, x - 1, y, z, 4)) {
                z11 = true;
            }

            if(z11 || this.getIsBlockSolid(world, x + 1, y, z, 5)) {
                z11 = true;
            }
