...
This version is **0.0.21a**, a *Multiplayer Classic* version of the game which was released on _**June 22, 2009**_.
...
You can learn about the version itself [on the Minecraft wiki](https://minecraft.wiki/w/Java_Edition_Classic_0.0.21a).
...
Player skins do load and they are cached and handled by the websocket proxy server. Skins and in-game names work off of the Discord username,
however you may add aliases for Discord usernames so they have different player names in `discord/server/aliases.txt`.
...
The rightmost hotbar button opens inventory. The most bottom right button is jump and the one above it toggles block picking mode.
