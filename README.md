...
This version is **Infdev 20100629**, an *Infdev* version of the game which was released on _**June 29, 2010**_. This is technically the first version of *Alpha* as the launcher was first released alongside this version.
...
You can learn about the version itself [on the Minecraft wiki](https://minecraft.wiki/w/Java_Edition_Infdev_20100629).
