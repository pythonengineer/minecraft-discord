...
This version is **Alpha v1.0.1_01**, an *Alpha* version of the game which was released on _**July 2, 2010**_. This is the oldest archived version formally named Alpha, the third *Seecret Friday* update, and it adds redstone to the game.
...
You can learn more about this particular version [on the Minecraft wiki](https://minecraft.wiki/w/Java_Edition_Alpha_v1.0.1_01).
